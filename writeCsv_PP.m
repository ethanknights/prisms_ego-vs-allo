...
for s = 1:height(t_wide); ID = t_wide.ID{s}; ID_num = t_wide.ID_num(s);
  ...
  for sess = 1:2
    ...
    %% Put variables in new tmpT table
    list_vars = {...
      'Error in mm',...
      'MouseClick1X',...
      'MouseClick1Y',...
    ...
    tmpT.SideofSpace =   [...
      repmat(1,length(idx_L15),1);...
      repmat(1,length(idx_L19),1);...
      repmat(1,length(idx_L23),1);...
      repmat(2,length(idx_R15),1);...
      repmat(2,length(idx_R19),1);...
      repmat(2,length(idx_R23),1);...
      ];
    tmpT.SideofSpaceStr =   [...
      repmat('L',length(idx_L15),1);...
      repmat('L',length(idx_L19),1);...
      repmat('L',length(idx_L23),1);...
      repmat('R',length(idx_R15),1);...
      repmat('R',length(idx_R19),1);...
      repmat('R',length(idx_R23),1);...
      ];
    tmpT.Eccentricity =   [...
      repmat(1,length(idx_L15),1);...
      repmat(2,length(idx_L19),1);...
      repmat(3,length(idx_L23),1);...
      repmat(1,length(idx_R15),1);...
      repmat(2,length(idx_R19),1);...
      repmat(3,length(idx_R23),1);...
      ];
    tmpT.EccentricityStr =   [...
      repmat('15',length(idx_L15),1);...
      repmat('19',length(idx_L19),1);...
      repmat('23',length(idx_L23),1);...
      repmat('15',length(idx_R15),1);...
      repmat('19',length(idx_R19),1);...
      repmat('23',length(idx_R23),1);...
      ];
